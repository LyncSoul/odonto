...
import com.odonto.filters.CorsFilter;
import com.odonto.filters.JwtRequestFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/dentistas/autenticacao").permitAll()
                .antMatchers("/dentistas/cadastro").permitAll()
                .antMatchers("/usuarios/cadastro").permitAll()
                .antMatchers("/dentistas/upload/*").permitAll()
